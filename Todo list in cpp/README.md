...
#INFERENCE:
OUT OF 16 TEST CASES,13 TEST CASES ARE SUCCESSFULL WITH THE AUTOMATIC TESTING USING NODE.JS. THE OTHER 3 WERE ALSO RIGHT BUT DID NOT PASS THE TEST CASE DUE TO SOME ENCODING ISSUE. IT DISPLAYED (MIDDLE DOT)SYMBOL WHEREVER ENDL OR "\N" WAS USED.
THE PROGRAM WOULD RUN ANWHERE WITH C++ ALREADY INSTALLED IN THE COMPUTER TO COMPILE AND BUILD IT.
